...
def train_baseline1(training_data_dir, test_data_dir, face_encoding_dir,
                    mid_name_path, experiment_dir, model_names=[]):
...
if __name__ == "__main__":
    ...
    ap.add_argument("--model_names", help="List models to train", default="./Experiment")
