    ...
    def train(self):
        ...
        if self.model_path is not None:
            ...
            if self.model_name == "VGG16":
                ...
                model_base.add(Conv2D(32, kernel_size=(3, 3), strides=(2, 2), activation=ReLU, input_shape=self.input_shape))
                model_base.add(Conv2D(32, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(MaxPool2D())
                model_base.add(Conv2D(64, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(Conv2D(64, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(MaxPool2D())
                model_base.add(Conv2D(128, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(Conv2D(128, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(Conv2D(128, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(MaxPool2D())
                model_base.add(Conv2D(256, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(Conv2D(256, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(Conv2D(256, kernel_size=(3, 3), strides=(2, 2), activation=ReLU))
                model_base.add(MaxPool2D())
